...
~/go/bin/fyne-cross darwin  -arch=amd64 -app-id com.tqdev.tunnel-launcher -macosx-sdk-path "$SDK" -image $DARWIN_IMAGE
~/go/bin/fyne-cross darwin  -arch=arm64 -app-id com.tqdev.tunnel-launcher -macosx-sdk-path "$SDK" -image $DARWIN_IMAGE
